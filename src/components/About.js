        ...
        <div className="about-container">
          <div className="wrapper row">
            ...
            <div className="info-wrapper col-lg-6">
              ...
              <p>I am a full stack developer who enjoy developing scalable project, and creating simple intuitive interfaces.</p>
              <p>Currently based in Toronto, Canada, I recently graduated from Brainstation Web Development Immersive Program that taught the latest web technologies and best practices. I constantly work on various projects that drive me to learn more about other tools and frameworks</p>
              <p>In my free time, I play ultimate frisbee, devour all you can eat sushi, and look for new ways to use technology to help non-profit cause.</p>
            </div>
          </div>
