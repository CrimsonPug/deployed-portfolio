          ...
          <div className="independence col-lg-6 col-sm-12">   
            <Card>
              <Link to="/independence-banking">
                ...
                <CardText>
                  A shared finance management application between a person with dementia(PWD) and a trusted caregiver. The application renders a simpler dashboard interface for PWD and notification is sent if there's transaction done on the other sides.
                </CardText>
              </Link>
              <CardActions>
